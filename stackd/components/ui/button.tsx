...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-lime text-bg font-semibold hover:bg-lime-dim active:scale-[0.97]",
  secondary:
    "bg-surface-2 text-text border border-border-strong hover:bg-muted-2 active:scale-[0.97]",
  ghost:
