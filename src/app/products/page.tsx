...
export default function ProductsPage() {
  const products = [
    ...
    {
      name: 'เสาป้ายโฆษณา',
      slug: 'advertising-pole',
      description: 'รับผลิตเสาป้ายโฆษณาเหล็กและสแตนเลส โครงสร้างแข็งแรงทนทาน รองรับป้ายขนาดใหญ่',
      features: [
        'โครงสร้างแข็งแรงรับแรงลม',
        'ทนทานต่อสภาพอากาศ',
        'ออกแบบตามขนาดที่ต้องการ',
        'พร้อมบริการติดตั้ง',
      ],
    },
    {
      name: 'ฝาถังเหล็กและแสตนเลส',
      slug: 'tank-lid',
      description: 'รับผลิตฝาถังเหล็กและสแตนเลสขึ้นรูปตามสั่ง ทั้งแบบฝาแบน ฝาโค้ง และฝาแรงดัน สำหรับงานอุตสาหกรรม',
      features: [
        'ขึ้นรูปฝาถังได้ทุกขนาด',
        'รองรับแรงดันสูง',
        'ผิวเรียบสวยงาม',
        'ผลิตจากเหล็กและสแตนเลสคุณภาพ',
      ],
    },
  ]
